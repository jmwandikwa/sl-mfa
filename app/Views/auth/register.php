							...
							<div class="p-40">
								...
								<div class="text-center">
								  ...
								  <p class="gap-items-2 mb-0">
									  <a class="waves-effect waves-circle btn btn-social-icon btn-circle btn-facebook-light" href="auth_register_dark.html#"><i class="fa fa-facebook"></i></a>
									  <a class="waves-effect waves-circle btn btn-social-icon btn-circle btn-twitter-light" href="auth_register_dark.html#"><i class="fa fa-twitter"></i></a>
									  <a class="waves-effect waves-circle btn btn-social-icon btn-circle btn-instagram-light" href="auth_register_dark.html#"><i class="fa fa-instagram"></i></a>
									</p>	
								</div>
							</div>
						</div>	
