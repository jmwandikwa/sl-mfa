					...
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-gray-800 rounded10 shadow-lg">
							<div class="content-top-agile px-20 pt-40 pb-0">
								<img src="/profile/<?= session()->get("user_image"); ?>" alt="User Image" class="bg-light rounded-circle avatar-xl">
								<h2 class="text-primary fw-600"><?= session()->get("user_name"); ?></h2>
								<p class="mb-5 text-fade">Enter your password to retrieve your session</p>	
							</div>
							<div class="px-40 pb-40 pt-20">
								<form action="/login/screen" method="post">
								...
								<div class="text-center">
									<p class="mt-15 mb-0 text-fade">Or <a href="/logout" class="text-primary">Sign In</a> as a Different User</p>
								</div>
							</div>
						</div>
					</div>
