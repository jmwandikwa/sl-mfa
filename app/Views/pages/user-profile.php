						...
						<div class="card-body">
							...
							<div class="text-start mt-3">
								...
								<p class="text-muted  mb-3">
									Hi I'm Nil Yeager,has been the industry's standard dummy text ever since the
									1500s, when an unknown printer took a galley of type.
								</p>
								<p class="text-muted mb-2 "><strong class="text-info">Full Name :</strong> <span class="ms-2">Nil Yeager</span></p>

								<p class="text-muted mb-2 "><strong class="text-info">Mobile :</strong><span class="ms-2">(123)123 1234</span></p>

								<p class="text-muted mb-2 "><strong class="text-info">Email :</strong> <span class="ms-2 ">user@email.domain</span></p>

								<p class="text-muted mb-1 "><strong class="text-info">Location :</strong> <span class="ms-2">USA</span></p>
							</div>
					...
					<div class="card">
						<div class="card-body">
							<div class="dropdown float-end">
								<a href="extra_profile.html#" class="dropdown-toggle no-caret" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<div>
								<div class="d-flex align-items-center mb-30">
									...
									<div class="d-flex flex-column flex-grow-1">
										<a href="extra_profile.html#" class="text-info hover-primary mb-1 fs-16">Sophia</a>
										<span class="text-mute fs-12">Project Manager</span>
									</div>
									<div>
										<a href="extra_profile.html#" class="btn btn-sm btn-primary-light">Reply</a>
									</div>
								</div>
								<div class="d-flex align-items-center mb-30">
									<div class="me-15">
									...
									<div class="d-flex flex-column flex-grow-1">
										<a href="extra_profile.html#" class="text-info hover-danger mb-1 fs-16">Mason</a>
								...
								<div class="d-flex align-items-center mb-30">
									...
									<div class="d-flex flex-column flex-grow-1">
										<a href="extra_profile.html#" class="text-info hover-success mb-1 fs-16">Emily</a>
								...
								<div class="d-flex align-items-center mb-30">
									...
									<div class="d-flex flex-column flex-grow-1">
										<a href="extra_profile.html#" class="text-info hover-info mb-1 fs-16">Daniel</a>
								...
								<div class="d-flex align-items-center">
									...
									<div class="d-flex flex-column flex-grow-1">
										<a href="extra_profile.html#" class="text-info hover-warning mb-1 fs-16">Natalie</a>
							...
							<div class="tab-content">
								...
								<div class="tab-pane show active" id="timelinest">
									...
									<div class="border rounded mt-2 mb-3">
										<form action="extra_profile.html#" class="comment-area-box">
											...
											<div class="p-2 bg-gray-100 d-flex justify-content-between align-items-center">
												<div>
													<a href="extra_profile.html#" class="btn btn-sm px-2 fs-16 btn-primary-light"><i class="mdi mdi-account-circle"></i></a>
													<a href="extra_profile.html#" class="btn btn-sm px-2 fs-16 btn-primary-light"><i class="mdi mdi-map-marker"></i></a>
													<a href="extra_profile.html#" class="btn btn-sm px-2 fs-16 btn-primary-light"><i class="mdi mdi-camera"></i></a>
													<a href="extra_profile.html#" class="btn btn-sm px-2 fs-16 btn-primary-light"><i class="mdi mdi-emoticon"></i></a>
												</div>
									...
									<div class="border border-light rounded p-2 mb-3">
										...
										<div class="my-2 p-15 mt-3">
											<div class="d-flex">
												...
												<div>
													...
													<div class="d-flex mt-3">
														<a class="pe-2" href="extra_profile.html#">
															<img class="me-25 rounded-circle bg-light" src="../../../images/avatar/avatar-2.png" alt="Generic placeholder image" height="32">
														</a>
														<div>
											...
											<div class="d-flex mt-2">
												...
												<div class="w-100">
													<input type="text" id="simpleinput" class="form-control border-0 form-control-sm" placeholder="Comment">
												</div>
											</div>
										</div>
