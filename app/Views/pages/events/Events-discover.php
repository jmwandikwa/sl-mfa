					...
					<div class="box">
						<div class="box-body">	
							...
							<div class="mt-20">
								...
								<p class="text-fade"><?= mb_strimwidth($event['event_description'], 0, 200, "...</strong></p>"); ?></p>

								<div class="d-flex flex-column w-p100 mt-30">
									<span  class="text-fade me-10 fs-16 fw-600 pb-15 count">
									</span>
								...
								<div class="mt-10 d-flex justify-content-between align-items-center">
									<a href="/dashboard/event/<?= $event['event_id']; ?>" class="waves-effect waves-light btn btn-primary mb-5">View Event</a>
